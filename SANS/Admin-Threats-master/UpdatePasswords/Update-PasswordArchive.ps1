...
# to optionally or mandatorily confirm the trust chain and revocation status, but it's too
# soon, not enough people have upgraded yet.  While waiting, we could have the script check
# a hard-coded hash of the cert and then sign the script, but that can't be the default.
