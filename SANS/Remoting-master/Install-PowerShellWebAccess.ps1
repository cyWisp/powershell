...
Install-WindowsFeature -Name WindowsPowerShellWebAccess -IncludeManagementTools -IncludeAllSubFeature -Restart
...
# is just an example, not necessarily what is appropriate for your real LAN; in
# particular, it specifies the default remoting endpoint ("microsoft.powershell"),
# but a Just Enough Admin (JEA) endpoint would be much better.  
